...
def process_url(base_url, target_url):
    ...
    year_str = title[:5] + "2次試験"  # 取前5个字符作为年度
...
def main():
    ...
    # 所有要处理的URL
    urls = [
        "/admission/high_school/ability_test/problem_and_answer/2nd_2024.html",  # 令和6年度2次試験
        "/admission/high_school/ability_test/problem_and_answer/2nd_2023.html",  # 令和5年度2次試験
        "/admission/high_school/ability_test/problem_and_answer/2nd_2022.html",  # 令和4年度2次試験
        "/admission/high_school/ability_test/problem_and_answer/2nd_2021.html",  # 令和3年度2次試験
        "/admission/high_school/ability_test/problem_and_answer/2nd_2020.html",  # 令和2年度
        "/admission/high_school/ability_test/problem_and_answer/2nd_2019.html",  # 平成31年度
    ]
